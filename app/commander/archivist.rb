module Archivist
  ...
  def Archivist.options_light_spy()
    options = {
      is_idle?: [true],
      is_less_flight_time?: [true, "1:410:4", 15000, 3150],
  ...
  def Archivist.options_close_idle_safe(from = "1:410:4")
    options = {
      is_idle?: [true],
      is_less_flight_time?: [true, from, 15000, 3150],
      is_safe?: [true],
      has_more_economy_score?: [true]
    }
  end

  def Archivist.options_idle(duration=3150, speed=15000, eco_score=100, from="1:410:4")
    options = {
      is_idle?: [true],
      get_galaxy: ["1"],
  ...
  # options = Archivist.options_idle(3150, 15000, 100, "1:410:4")
